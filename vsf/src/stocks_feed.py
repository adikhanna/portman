...
class TopStocksFeed(QtWidgets.QWidget):
    def __init__(self, yahoo_stocks: YahooStocks,
        ...
        self.logView = QtWidgets.QTableWidget(0, 2)
        ...
        for i in range(max(len(self.gainers), len(self.most_active))):
    ...
    def on_data_ready(self):
        for index, (gainer, most_active) in enumerate(zip(self.gainers["Symbol"],
